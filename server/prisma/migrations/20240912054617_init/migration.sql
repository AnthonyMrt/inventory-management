...
CREATE TABLE "PurchaseSummary" (
    "purchaseSummary" TEXT NOT NULL,
    "totalPurchased" DOUBLE PRECISION NOT NULL,
    "changePercentage" DOUBLE PRECISION,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "PurchaseSummary_pkey" PRIMARY KEY ("purchaseSummary")
);
...
CREATE TABLE "ExpenseSummary" (
    ...
    CONSTRAINT "ExpenseSummary_pkey" PRIMARY KEY ("expensesSummaryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpenseByCategory" ADD CONSTRAINT "ExpenseByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpenseSummary"("expensesSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
